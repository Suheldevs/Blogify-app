    ...
    <Navbar className='border-b-2'>
        ...
        <div className='flex gap-3 md:order-2'>
            ...
            {currentUser?(
                ...
                >
<Dropdown.Header>
    <sapn className='block text-sm'>@{currentUser.username}</sapn>
    <sapn className='block text-sm font-medium truncate'>{currentUser.email}</sapn>
</Dropdown.Header>
<Link to='/dashboard?tab=profile'>
<Dropdown.Item>
    Profile
    </Dropdown.Item><DropdownDivider/></Link>
    <Link to='/'>
    <Dropdown.Item>
        Sign Out
        </Dropdown.Item></Link>
